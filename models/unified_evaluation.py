...
class RepresentationSpaceAnalyzer:
    ...
    def fit_on_training_data(self, model, train_data):
        ...
        self.train_representations_pca = self.pca.fit_transform(
        ...
        self.train_representations_umap = self.umap_reducer.fit_transform(
            self.train_representations
        )
    ...
    def categorize_test_data(self, model, test_data):
        ...
        distances = self._compute_nearest_neighbor_distances(
            test_representations_pca, self.train_representations_pca
        )
    ...
    def visualize_representation_space(self, model, test_data, save_path=None):
        ...
        ax1.scatter(
            self.train_representations_umap[:, 0],
        ...
        for category in colors:
            ...
            ax2.scatter(
                test_representations_umap[mask, 0],
...
class ModificationEvaluator:
        ...
        modifications.append(
            {
                ...
                "validation": lambda traj: self._validate_physics_trajectory(
                    traj, high_gravity=True
                ),
            }
        )
        ...
        modifications.append(
            {
                ...
                "transform": lambda seq: seq.replace("jump", "__temp__")
                .replace("walk", "jump")
                .replace("__temp__", "walk"),
    ...
    def evaluate_modification_success(self, model, modification_suite, test_data):
        ...
        for mod in modification_suite:
            ...
            validation_scores = [mod["validation"](pred) for pred in predictions]
...
class UnifiedEvaluator:
    ...
    def _evaluate_representation_space(self, model, test_data):
        ...
        categorization = self.representation_analyzer.categorize_test_data(
            model, test_data
        )

        results = {"interpolation_acc": [], "near_extrap_acc": [], "far_extrap_acc": []}
    ...
    def _evaluate_efficiency(self, model, test_data):
        ...
        return {"inference_time": inference_time, "adaptation_time": adaptation_time}
...
if __name__ == "__main__":
    ...
    # Initialize models
    config = {"task_type": "physics", "input_shape": (4,), "output_shape": (100, 2)}

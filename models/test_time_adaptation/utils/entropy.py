...
def confidence_selection(probs: Any, threshold: float = 0.9) -> Any:
...
def symmetric_entropy_loss(probs: Any, eps: float = 1e-7) -> Any:
...
def diversity_loss(probs: Any, target_distribution: Any = None) -> Any:
    ...
    kl_div = ops.sum(avg_probs * ops.log(avg_probs / (target_distribution + 1e-7)))

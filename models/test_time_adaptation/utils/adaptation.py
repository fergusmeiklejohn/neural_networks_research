...
def update_bn_stats(model: keras.Model, data: Any, momentum: float = 0.1) -> None:
...
def compute_feature_statistics(features: Any) -> Tuple[Any, Any]:
...
def align_features(
    source_features: Any, target_mean: Any, target_var: Any, eps: float = 1e-5
) -> Any:
...
def exponential_moving_average_update(
    current_value: Any, new_value: Any, momentum: float = 0.9
) -> Any:

...
class PhysicsTTT(BaseTTA):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.auxiliary_tasks = auxiliary_tasks or ['reconstruction', 'consistency', 'smoothness']
    ...
    def adapt_online(
        ...
        if len(self.adaptation_state['observed_trajectory']) >= self.adaptation_window:
            ...
            trajectory = ops.stack(self.adaptation_state['observed_trajectory'][-self.adaptation_window:])
            ...
            # Slide window
            if len(self.adaptation_state['observed_trajectory']) > self.trajectory_length:

...
class BaseTTAJax(ABC):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.stateless_call = (
            model.stateless_call if hasattr(model, "stateless_call") else None
        )
    ...
    def _loss_fn(
        self, params: List[Any], x: Any, non_trainable_params: List[Any]
    ) -> float:
    ...
    def adapt_step(self, x: Any) -> Tuple[Any, float]:
        ...
        trainable_params = [
            ops.convert_to_numpy(w) for w in self.model.trainable_variables
        ]
        non_trainable_params = [
            ops.convert_to_numpy(w) for w in self.model.non_trainable_variables
        ]
        ...
        loss_fn_partial = partial(
            self._loss_fn, x=x_jax, non_trainable_params=non_trainable_params_jax
        )

...
def main():
    ...
    # Training dataset
    train_dataset = (
        keras.utils.tf_dataset.from_tensor_slices(
    ...
    callbacks = [
        ...
        keras.callbacks.EarlyStopping(
            monitor="val_val_error", patience=10, restore_best_weights=True
        ),
        keras.callbacks.ReduceLROnPlateau(
            monitor="val_val_error", factor=0.5, patience=5, min_lr=1e-6
        ),
    ]

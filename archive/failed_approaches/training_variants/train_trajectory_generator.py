...
class TrajectoryReconstructor(keras.Model):
    ...
    def call(self, inputs, training=None):
        ...
        physics_seq = ops.repeat(
            ops.expand_dims(physics_features, axis=1), seq_length, axis=1
        )
...
def load_and_prepare_trajectory_data(data_path: str, max_samples: int = None):
    ...
    print(
        f"Data shapes: X_physics={X_physics_norm.shape}, y_trajectories={y_traj_norm.shape}"
    )

...
def analyze_tta_behavior(model, trajectory, tta_kwargs, name="TTA Analysis"):
    ...
    if hasattr(adapter, 'adaptation_metrics') and adapter.adaptation_metrics['adaptation_loss']:
...
def main():
    ...
    scenarios = [
        ('In-distribution', const_data['trajectories'][50]),  # Use a trajectory not in training

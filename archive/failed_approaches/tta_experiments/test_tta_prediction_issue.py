...
def main():
    ...
    bn_layer = [l for l in model.layers if isinstance(l, keras.layers.BatchNormalization)][0]
    ...
    print(f"- Model predictions changed after adapt: {'YES' if diff_3 > 1e-6 else 'NO'}")

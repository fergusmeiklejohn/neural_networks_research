...
class CompositionTestSuite:
    ...
    def __init__(
        self, model_path: str = "outputs/mixed_curriculum/best_mixed_model.npz"
    ):
    ...
    def _test_pattern(
        self, pattern: str, expected: List[str]
    ) -> Tuple[bool, List[str]]:
    ...
    def test_nested_composition(self):
        ...
        patterns = [
            ...
            (
                ...
                ["JUMP", "WALK", "JUMP", "WALK"],
            ),  # Interpretation: do both X and Y, twice
            # Complex nesting
            (
        ...
        for pattern, expected in patterns:
            ...
            print(f"   Got:      {predictions}")
            print(
                f"   Note: These patterns test the limits of compositional understanding"
            )

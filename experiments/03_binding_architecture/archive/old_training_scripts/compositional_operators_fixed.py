...
class CompositionalExecutor:
    ...
    def execute(self, parse_tree: ParseNode, command_ids, 
                bindings: Dict[str, str], stage: str = "full") -> List:
    ...
    def _execute_leaf(self, node: ParseNode, command_ids,
                      bindings: Dict[str, str], stage: str) -> List:
    ...
    def _execute_sequence(self, node: ParseNode, command_ids,
                          bindings: Dict[str, str], stage: str) -> List:
    ...
    def _execute_parallel(self, node: ParseNode, command_ids,
                          bindings: Dict[str, str], stage: str) -> List:
    ...
    def _execute_loop(self, node: ParseNode, command_ids,
                      bindings: Dict[str, str], stage: str) -> List:
    ...
    def _execute_choice(self, node: ParseNode, command_ids,
                        bindings: Dict[str, str], stage: str) -> List:

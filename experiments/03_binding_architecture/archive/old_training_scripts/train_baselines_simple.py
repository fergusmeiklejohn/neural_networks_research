...
def main():
    ...
    transformer = create_baseline_model('transformer', vocab_size, embed_dim=64, num_heads=4, num_layers=2)
    ...
    ff = create_baseline_model('feedforward', vocab_size, context_window=5, hidden_dim=128)

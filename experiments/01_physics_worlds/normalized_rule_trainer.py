...
def train_normalized_predictor():
    ...
    accuracy_metrics = calculate_physics_accuracy(y_val_orig, y_pred_orig, tolerance=0.1)
    
    print(f"\nResults on original scale:")
    print(f"Overall accuracy (10% tolerance): {accuracy_metrics['overall']['accuracy']:.3f}")

    ...
    def train(self, train_data, val_data, epochs=50, exploration_steps=100):
        ...
        for step in range(exploration_steps):
            ...
            if step % 10 == 0:
                ...
                if step % 50 == 0:
                    print(f"Step {step}: D_loss={d_loss_real:.4f}/{d_loss_fake:.4f}, "
    ...
    def predict(self, inputs):
        ...
        if hasattr(self, 'test_time_exploration') and self.test_time_exploration:
            ...
            for _ in range(5):
                ...
                varied = base_predictions + self.explorer.predict(base_predictions + noise)
...
class PhysicsMAMLBaseline:
    ...
    def build_model(self):
        ...
        self.model_copy.compile(
            optimizer=keras.optimizers.SGD(self.inner_lr),
            loss='mse'
        )
        ...
        for epoch in range(epochs):
            ...
            for task in tasks:
                ...
                for _ in range(self.inner_steps):
                    self.model_copy.train_on_batch(
                        task['support_x'], 
                        task['support_y']
                    )
            ...
            if epoch % 10 == 0:
                ...
                print(f"Epoch {epoch}: Meta Loss = {epoch_loss/len(tasks):.4f}, "
...
class PhysicsGraphExtrapolationBaseline:
    ...
    def compute_geometric_features(self, state):
        ...
        return tf.stack([
            dist, rel_x, rel_y, rel_vx, rel_vy,

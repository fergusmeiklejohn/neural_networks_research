...
def create_minimal_test_data():
    ...
    def create_sample(num_balls=3, gravity=9.81, friction=0.1):
        ...
        return {
            ...
            'initial_balls': [{'x': p[0], 'y': p[1], 'vx': v[0], 'vy': v[1], 
                              'radius': 0.5, 'mass': 1.0, 'color': 'blue'}
    ...
    print(f"Created minimal dataset: {len(train_data)} train, {len(val_data)} val, "

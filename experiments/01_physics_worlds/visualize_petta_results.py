...
def create_petta_comparison_figure():
    ...
    ax5.axhline(
        y=0.769 * 0.1, color="r", linestyle="--", label="Collapse Threshold", alpha=0.5
    )
...
introduce new computational structure"""
    ...
    plt.suptitle(
        "PeTTA-Inspired Collapse Detection on Pendulum Mechanism Shift",
        fontsize=16,
        fontweight="bold",
    )
    plt.tight_layout()
    ...
    plt.savefig(
        "outputs/pendulum_tta/petta_comprehensive_results.png",
        dpi=300,
        bbox_inches="tight",
    )
...
def create_mechanism_explanation_figure():
    ...
    plt.suptitle(
        "Why Collapse Detection Doesn't Help with Mechanism Shifts",
        fontsize=16,
        fontweight="bold",
    )
    plt.tight_layout()
    ...
    plt.savefig(
        "outputs/pendulum_tta/petta_mechanism_explanation.png",
        dpi=300,
        bbox_inches="tight",
    )

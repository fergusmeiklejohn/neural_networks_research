    ...
    def simulate_trajectory(
        ...
        for step in range(steps):
            ...
            trajectory_point = [
                ...
                y1,
                vx1,
                vy1,  # 1-4: ball 1 kinematics
                m1,
                r1,  # 5-6: ball 1 properties
                0.0,
                0.0,  # 7-8: padding
                x2,
                y2,
                vx2,
                vy2,  # 9-12: ball 2 kinematics
                m2,
                r2,  # 13-14: ball 2 properties
                0.0,
                0.0,  # 15-16: padding
            ]
...
def verify_ood_with_representation_space(
    ood_data: List[Dict], train_representation_path: str = None
) -> Dict:
    """

...
class ConstantGravityPhysicsSimulator:
    ...
    def simulate_trajectory(
        ...
        for t in range(timesteps):
            ...
            # Apply forces
            # Gravity
            ay1 = -gravity_pixels  # Negative because y-axis points down in screen coords
            ay2 = -gravity_pixels
            ...
            trajectory_point = [
                t * self.dt,  # time
                x1, y1, vx1, vy1, ax1, ay1, m1, r1,  # ball 1
                x2, y2, vx2, vy2, ax2, ay2, m2, r2   # ball 2
            ]
...
def generate_constant_gravity_data(n_samples: int = 5000, gravity_range=(-12, -8)) -> List[Dict]:

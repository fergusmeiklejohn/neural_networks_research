...
# Title
ax.text(5, 9.5, 'Distribution Shift Taxonomy', 
...
level1_box = FancyBboxPatch((0.5, 6.5), 2.8, 2.3,
...
ax.text(1.9, 8.3, 'Level 1: Surface Variations', 
        fontsize=14, fontweight='bold', ha='center')
ax.text(1.9, 7.9, 'Same computation,\ndifferent appearance', 
        fontsize=11, ha='center', style='italic')

# Examples for Level 1
ax.text(1.9, 7.3, '• Image noise/blur\n• Style transfer\n• Sensor variations', 
        fontsize=10, ha='center', va='top')

# Performance box for Level 1
perf1_box = Rectangle((0.7, 6.6), 2.4, 0.5,
                     facecolor='white', edgecolor='#4CAF50', linewidth=1)
ax.add_patch(perf1_box)
ax.text(1.9, 6.85, 'TTA: ✓ Improves (-13%)', 
        fontsize=10, ha='center', color='#2E7D32', fontweight='bold')

# Level 2: Statistical Shifts
level2_box = FancyBboxPatch((3.6, 6.5), 2.8, 2.3,
                           boxstyle="round,pad=0.1",
...
ax.text(5.0, 8.3, 'Level 2: Statistical Shifts', 
        fontsize=14, fontweight='bold', ha='center')
ax.text(5.0, 7.9, 'Same process,\ndifferent statistics', 
        fontsize=11, ha='center', style='italic')

# Examples for Level 2
ax.text(5.0, 7.3, '• Object frequencies\n• Demographic shifts\n• Seasonal variations', 
        fontsize=10, ha='center', va='top')

# Performance box for Level 2
perf2_box = Rectangle((3.8, 6.6), 2.4, 0.5,
                     facecolor='white', edgecolor='#FF9800', linewidth=1)
ax.add_patch(perf2_box)
ax.text(5.0, 6.85, 'TTA: ~ Marginal (-6%)', 
        fontsize=10, ha='center', color='#E65100', fontweight='bold')

# Level 3: Mechanism Changes
level3_box = FancyBboxPatch((6.7, 6.5), 2.8, 2.3,
                           boxstyle="round,pad=0.1",
...
ax.text(8.1, 8.3, 'Level 3: Mechanism Changes', 
        fontsize=14, fontweight='bold', ha='center')
ax.text(8.1, 7.9, 'New computation\nrequired', 
        fontsize=11, ha='center', style='italic')

# Examples for Level 3
ax.text(8.1, 7.3, '• g → g(t)\n• L → L(t)\n• Rule changes', 
        fontsize=10, ha='center', va='top')

# Performance box for Level 3
perf3_box = Rectangle((6.9, 6.6), 2.4, 0.5,
                     facecolor='white', edgecolor='#F44336', linewidth=1)
ax.add_patch(perf3_box)
ax.text(8.1, 6.85, 'TTA: ✗ Degrades (238%)', 
        fontsize=10, ha='center', color='#B71C1C', fontweight='bold')

# Arrows showing progression
arrow1 = FancyArrowPatch((3.3, 7.65), (3.6, 7.65),
...
arrow2 = FancyArrowPatch((6.4, 7.65), (6.7, 7.65),
                        connectionstyle="arc3", 
                        arrowstyle='->', 
                        mutation_scale=20,
                        linewidth=2,
...
physics_box = FancyBboxPatch((1, 3.5), 8, 2.5,
                            boxstyle="round,pad=0.1",
                            facecolor='#F5F5F5',
                            edgecolor='#616161',
                            linewidth=2)
...
ax.text(5, 5.7, 'Physics System Examples', 
        fontsize=16, fontweight='bold', ha='center')

# Two-ball system
ball_box = FancyBboxPatch((1.5, 4.3), 3, 1,
...
ax.text(3, 4.5, 'Test: g(t) = 9.8 + 2sin(0.1t)', fontsize=10, ha='center', color='#B71C1C')

# Pendulum system
pend_box = FancyBboxPatch((5.5, 4.3), 3, 1,
                         boxstyle="round,pad=0.05",
                         facecolor='white',
                         edgecolor='#9E9E9E',
                         linewidth=1)
...
ax.text(7, 4.5, 'Test: L(t) = L₀(1 + 0.2sin(0.1t))', fontsize=10, ha='center', color='#B71C1C')
...
ax.text(5, 2.2, 'Test-Time Adaptation (TTA) methods optimize self-supervised objectives\n'

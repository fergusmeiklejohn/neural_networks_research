...
from simple_baseline_v2 import create_simple_model, load_and_prepare_data
...
def main():
    parser = argparse.ArgumentParser(description='Train simple baseline with full dataset')
    ...
    output_dir = base_dir / 'outputs' / f'simple_baseline_full_{datetime.now().strftime("%Y%m%d_%H%M%S")}'

...
def compare_stages(stage1_path, stage2_path, vocab_path, num_samples=10):
    ...
    model = create_model(
        len(tokenizer.command_word_index),
        len(tokenizer.action_word_index)
    )
    ...
    print(f"Stage 1 accuracy: {stage1_correct}/{num_samples} ({stage1_correct/num_samples*100:.1f}%)")
    print(f"Stage 2 accuracy: {stage2_correct}/{num_samples} ({stage2_correct/num_samples*100:.1f}%)")
...
def main():
    ...
    parser.add_argument('--stage1', default='compositional_language_complete_20250722_185804/outputs/safeguarded_training/checkpoints/stage_1_epoch_5.h5')
    parser.add_argument('--stage2', default='compositional_language_complete_20250722_185804/outputs/safeguarded_training/checkpoints/stage_2_epoch_1.h5')
    parser.add_argument('--vocabulary', default='compositional_language_complete_20250722_185804/outputs/safeguarded_training/vocabulary.json')

    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            if hasattr(tokenizer, 'save'):
                ...
                print("⚠️  WARNING: Use tokenizer.save_vocabulary(), not tokenizer.save()")
            else:
            ...
            print(f"✓ Vocabulary built: {len(tokenizer.command_to_id)} commands, {len(tokenizer.action_to_id)} actions")
            ...
            if issues:
                ...
                if any('tokenizer.save()' in issue for issue in issues):
                    print("  1. Replace all instances of tokenizer.save() with tokenizer.save_vocabulary()")

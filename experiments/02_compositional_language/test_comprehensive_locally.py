...
class LocalTestRunner(ComprehensiveExperimentRunner):
    ...
    def __init__(self):
        ...
        self.output_dir = self.base_path / 'experiments' / '02_compositional_language' / 'test_comprehensive_local'
    ...
    def run_experiment(self, experiment_name, model_version='v1', use_mixed_training=False):
        ...
        saved_method = self.run_experiment
        ...
        for stage_idx, stage in enumerate(test_stages):
            ...
            if stage['mix_ratio'] == 0.0:
                ...
                dataset = create_dataset(self.train_data[:100], self.tokenizer, batch_size=8)
            else:

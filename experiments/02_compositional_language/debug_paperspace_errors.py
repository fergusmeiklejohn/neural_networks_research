...
try:
    ...
    try:
        ...
        print(
            f"✓ Rule extractor works, embeddings shape: {rule_outputs['embeddings'].shape}"
        )
    except Exception as e:
    ...
    def test_cond():
        def apply_mod():
            ...
            modified, gates = model_v2.rule_modifier(
                rule_embeddings, modification, training=True
            )
        ...
        result = tf.cond(mod_sum > 0, apply_mod, keep_orig)
        return result

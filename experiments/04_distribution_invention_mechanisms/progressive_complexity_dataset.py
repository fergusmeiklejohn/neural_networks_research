...
VOCAB = {
    'PAD': 0, 'do': 1, 'means': 2, 'is': 3, 'and': 4, 'or': 5,
    'then': 6, 'twice': 7, 'thrice': 8, 'while': 9,
    'X': 10, 'Y': 11, 'Z': 12, 'W': 13,
    'jump': 14, 'walk': 15, 'run': 16, 'turn': 17,
    'true': 18
}
...
class ProgressiveComplexityDataset:
    ...
    def generate_all_levels(self, samples_per_level: int = 100) -> Dict[str, List[Dict]]:
